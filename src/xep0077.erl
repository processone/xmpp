...
decode_register_els(__TopXMLNS, __Opts, [], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    {Xdata,
     Registered,
     Remove,
     Instructions,
...
decode_register_els(__TopXMLNS, __Opts,
                    ...
                    Xdata, Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"remove">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"name">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"address">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"city">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"state">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"zip">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"phone">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"url">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"date">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"misc">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"text">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts,
                    [{xmlel, <<"key">>, _attrs, _} = _el | _els], Xdata,
                    Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
...
decode_register_els(__TopXMLNS, __Opts, [_ | _els],
                    Xdata, Registered, Remove, Instructions, Username, Nick,
                    Password, Name, First, Last, Email, Address, City,
                    State, Zip, Phone, Url, Date, Misc, Text, Key, __Els) ->
    decode_register_els(__TopXMLNS,
...
encode_register({register,
    ...
    _els = [xmpp_codec:encode(_el, __NewTopXMLNS)
            || _el <- __Els]
               ++
               lists:reverse('encode_register_$key'(Key,
                                                    __NewTopXMLNS,
...
decode_register_key(__TopXMLNS, __Opts,
    ...
    Cdata = decode_register_key_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_register_url(__TopXMLNS, __Opts,
    ...
    Cdata = decode_register_url_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
...
decode_register_zip(__TopXMLNS, __Opts,
    ...
    Cdata = decode_register_zip_els(__TopXMLNS,
                                    __Opts,
                                    _els,
                                    <<>>),
    Cdata.
