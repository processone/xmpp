...
decode_sm_failed(__TopXMLNS, __Opts,
    ...
    {Text, Reason} = decode_sm_failed_els(__TopXMLNS,
                                          ...
                                          [],
                                          undefined),
    {H, Xmlns} = decode_sm_failed_attrs(__TopXMLNS,
                                        _attrs,
                                        undefined,
                                        undefined),
...
decode_sm_a(__TopXMLNS, __Opts,
            {xmlel, <<"a">>, _attrs, _els}) ->
    {H, Xmlns} = decode_sm_a_attrs(__TopXMLNS,
                                   _attrs,
                                   undefined,
                                   undefined),
    {sm_a, H, Xmlns}.
...
decode_sm_r(__TopXMLNS, __Opts,
            {xmlel, <<"r">>, _attrs, _els}) ->
    Xmlns = decode_sm_r_attrs(__TopXMLNS,
                              _attrs,
                              undefined),
    {sm_r, Xmlns}.
...
decode_feature_sm(__TopXMLNS, __Opts,
    ...
    Xmlns = decode_feature_sm_attrs(__TopXMLNS,
                                    _attrs,
                                    undefined),
    {feature_sm, Xmlns}.
