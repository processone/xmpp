...
encode_x509_revoke({x509_revoke, Cert, Signature},
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"urn:xmpp:x509:0">>,
                                    ...
                                    __TopXMLNS),
    _els =
        lists:reverse('encode_x509_revoke_$signature'(Signature,
                                                      __NewTopXMLNS,
                                                      'encode_x509_revoke_$cert'(Cert,
                                                                                 __NewTopXMLNS,
                                                                                 []))),
    _attrs = xmpp_codec:enc_xmlns_attrs(__NewTopXMLNS,
                                        __TopXMLNS),
...
encode_x509_request({x509_request,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"urn:xmpp:x509:0">>,
                                    ...
                                    __TopXMLNS),
    _els =
        lists:reverse('encode_x509_request_$signature'(Signature,
                                                       __NewTopXMLNS,
                                                       'encode_x509_request_$cert'(Cert,
                                                                                   __NewTopXMLNS,
                                                                                   'encode_x509_request_$csr'(Csr,
                                                                                                              __NewTopXMLNS,
                                                                                                              [])))),
    _attrs =
