...
records() ->
    [{x509_csr, 2}, {x509_cert_chain, 2}, {x509_ca_list, 1},
     {x509_request, 4}, {x509_revoke, 2},
     {x509_challenge, 3}, {x509_challenge_failed, 0},
     {x509_register, 0}].
...
decode_x509_challenge_failed(__TopXMLNS, __Opts,
			     {xmlel, <<"x509-challenge-failed">>, _attrs,
			      _els}) ->
    {x509_challenge_failed}.
...
decode_x509_challenge(__TopXMLNS, __Opts,
    ...
    Signature = decode_x509_challenge_els(__TopXMLNS,
					  __Opts, _els, error),
    {Transaction, Uri} =
	decode_x509_challenge_attrs(__TopXMLNS, _attrs,
				    undefined, undefined),
...
decode_x509_challenge_els(__TopXMLNS, __Opts,
	...
	of
      <<"urn:xmpp:x509:0">> ->
	  decode_x509_challenge_els(__TopXMLNS, __Opts, _els,
				    {value,
...
decode_x509_challenge_attrs(__TopXMLNS,
			    ...
			    Uri) ->
    decode_x509_challenge_attrs(__TopXMLNS, _attrs, _val,
				Uri);
decode_x509_challenge_attrs(__TopXMLNS,
...
encode_x509_challenge({x509_challenge, Transaction, Uri,
		       Signature},
		      __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"urn:xmpp:x509:0">>, [],
...
decode_x509_challenge_attr_transaction(__TopXMLNS,
				       undefined) ->
    erlang:error({xmpp_codec,
		  {missing_attr, <<"transaction">>, <<"x509-challenge">>,
		   __TopXMLNS}});
decode_x509_challenge_attr_transaction(__TopXMLNS,
				       _val) ->
    _val.
...
decode_x509_challenge_attr_uri(__TopXMLNS, undefined) ->
    erlang:error({xmpp_codec,
		  {missing_attr, <<"uri">>, <<"x509-challenge">>,
		   __TopXMLNS}});
...
decode_x509_revoke_els(__TopXMLNS, __Opts,
	...
	of
      <<"urn:xmpp:x509:0">> ->
	  decode_x509_revoke_els(__TopXMLNS, __Opts, _els,
				 {value,
				  decode_x509_cert(<<"urn:xmpp:x509:0">>,
						   __Opts, _el)},
				 Signature);
      _ ->
	  decode_x509_revoke_els(__TopXMLNS, __Opts, _els, Cert,
				 Signature)
    end;
decode_x509_revoke_els(__TopXMLNS, __Opts,
...
decode_x509_request(__TopXMLNS, __Opts,
    ...
    {Csr, Cert, Signature} =
	decode_x509_request_els(__TopXMLNS, __Opts, _els, error,
				undefined, undefined),
...
decode_x509_request_els(__TopXMLNS, __Opts,
	...
	of
      <<"urn:xmpp:x509:0">> ->
	  decode_x509_request_els(__TopXMLNS, __Opts, _els,
				  {value,
				   decode_x509_csr(<<"urn:xmpp:x509:0">>,
						   __Opts, _el)},
				  Cert, Signature);
      _ ->
	  decode_x509_request_els(__TopXMLNS, __Opts, _els, Csr,
				  Cert, Signature)
    end;
decode_x509_request_els(__TopXMLNS, __Opts,
...
decode_x509_request_attrs(__TopXMLNS, [_ | _attrs],
			  Transaction) ->
    decode_x509_request_attrs(__TopXMLNS, _attrs,
			      Transaction);
decode_x509_request_attrs(__TopXMLNS, [],
			  Transaction) ->
...
encode_x509_request({x509_request, Transaction, Csr,
		     Cert, Signature},
		    __TopXMLNS) ->
    __NewTopXMLNS =
	xmpp_codec:choose_top_xmlns(<<"urn:xmpp:x509:0">>, [],
...
decode_x509_request_attr_transaction(__TopXMLNS,
				     undefined) ->
    erlang:error({xmpp_codec,
		  {missing_attr, <<"transaction">>, <<"x509-request">>,
		   __TopXMLNS}});
decode_x509_request_attr_transaction(__TopXMLNS,
				     _val) ->
    _val.
...
decode_x509_signature(__TopXMLNS, __Opts,
    ...
    Cdata = decode_x509_signature_els(__TopXMLNS, __Opts,
				      _els, <<>>),
    Cdata.
...
decode_x509_signature_els(__TopXMLNS, __Opts,
    ...
    decode_x509_signature_els(__TopXMLNS, __Opts, _els,
...
decode_x509_ca_list(__TopXMLNS, __Opts,
    ...
    Certs = decode_x509_ca_list_els(__TopXMLNS, __Opts,
				    _els, []),
    {x509_ca_list, Certs}.
...
decode_x509_ca_list_els(__TopXMLNS, __Opts,
	...
	of
      <<"urn:xmpp:x509:0">> ->
	  decode_x509_ca_list_els(__TopXMLNS, __Opts, _els,
				  [decode_x509_cert(<<"urn:xmpp:x509:0">>,
						    __Opts, _el)
				   | Certs]);
      _ ->
...
'encode_x509_ca_list_$certs'([Certs | _els], __TopXMLNS,
			     _acc) ->
    'encode_x509_ca_list_$certs'(_els, __TopXMLNS,
				 [encode_x509_cert(Certs, __TopXMLNS) | _acc]).

decode_x509_cert_chain(__TopXMLNS, __Opts,
		       {xmlel, <<"x509-cert-chain">>, _attrs, _els}) ->
    Certs = decode_x509_cert_chain_els(__TopXMLNS, __Opts,
				       _els, []),
    Name = decode_x509_cert_chain_attrs(__TopXMLNS, _attrs,
					undefined),
...
decode_x509_cert_chain_els(__TopXMLNS, __Opts,
	...
	of
      <<"urn:xmpp:x509:0">> ->
	  decode_x509_cert_chain_els(__TopXMLNS, __Opts, _els,
				     [decode_x509_cert(<<"urn:xmpp:x509:0">>,
						       __Opts, _el)
				      | Certs]);
      _ ->
...
'encode_x509_cert_chain_$certs'([Certs | _els],
				__TopXMLNS, _acc) ->
    'encode_x509_cert_chain_$certs'(_els, __TopXMLNS,
...
decode_x509_csr(__TopXMLNS, __Opts,
    ...
    Der = decode_x509_csr_els(__TopXMLNS, __Opts, _els,
			      <<>>),
    Name = decode_x509_csr_attrs(__TopXMLNS, _attrs,
				 undefined),
    {x509_csr, Name, Der}.
...
decode_x509_csr_els(__TopXMLNS, __Opts,
    ...
    decode_x509_csr_els(__TopXMLNS, __Opts, _els,
...
decode_x509_cert(__TopXMLNS, __Opts,
    ...
    Cdata = decode_x509_cert_els(__TopXMLNS, __Opts, _els,
				 <<>>),
    Cdata.
...
decode_x509_cert_els(__TopXMLNS, __Opts,
		     [{xmlcdata, _data} | _els], Cdata) ->
    decode_x509_cert_els(__TopXMLNS, __Opts, _els,
			 <<Cdata/binary, _data/binary>>);
