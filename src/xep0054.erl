...
decode_vcard_temp_els(__TopXMLNS, __Opts, [], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
    {N,
     lists:reverse(Adr),
     lists:reverse(Label),
     lists:reverse(Tel),
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"N">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"ADR">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"LABEL">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"TEL">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"EMAIL">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"GEO">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"LOGO">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"PHOTO">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"ORG">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"SOUND">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"KEY">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"VERSION">>, _attrs, _} = _el | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"FN">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"NICKNAME">>, _attrs, _} = _el | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"BDAY">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"JABBERID">>, _attrs, _} = _el | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"MAILER">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"TZ">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"TITLE">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"ROLE">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"NOTE">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"PRODID">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"REV">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"SORT-STRING">>, _attrs, _} = _el | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"UID">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"URL">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"DESC">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"CATEGORIES">>, _attrs, _} = _el | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, <<"CLASS">>, _attrs, _} = _el | _els], N, Adr,
                      Label, Tel, Email, Geo, Logo, Photo, Org, Sound, Key,
                      Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts,
                      [{xmlel, _name, _attrs, _} = _el | _els], N, Adr, Label,
                      Tel, Email, Geo, Logo, Photo, Org, Sound, Key, Version,
                      Fn, Nickname, Bday, Jabberid, Mailer, Tz, Title, Role,
                      Note, Prodid, Rev, Sort_string, Uid, Url, Desc,
                      Categories, Class, __Els) ->
...
decode_vcard_temp_els(__TopXMLNS, __Opts, [_ | _els], N,
                      Adr, Label, Tel, Email, Geo, Logo, Photo, Org, Sound,
                      Key, Version, Fn, Nickname, Bday, Jabberid, Mailer, Tz,
                      Title, Role, Note, Prodid, Rev, Sort_string, Uid, Url,
                      Desc, Categories, Class, __Els) ->
...
encode_vcard_temp({vcard_temp,
    ...
    _els = [xmpp_codec:encode(_el, __NewTopXMLNS)
            || _el <- __Els]
               ++
               lists:reverse('encode_vcard_temp_$class'(Class,
                                                        __NewTopXMLNS,
...
decode_vcard_KEY(__TopXMLNS, __Opts,
    ...
    {Type, Cred} = decode_vcard_KEY_els(__TopXMLNS,
                                        __Opts,
                                        _els,
                                        undefined,
                                        undefined),
...
decode_vcard_KEY_els(__TopXMLNS, __Opts, [], Type,
                     Cred) ->
    {Type, Cred};
...
decode_vcard_KEY_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"CRED">>, _attrs, _} = _el | _els], Type,
                     Cred) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_SOUND_els(__TopXMLNS, __Opts, [], Binval,
                       Extval, Phonetic) ->
    {Binval, Extval, Phonetic};
decode_vcard_SOUND_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"BINVAL">>, _attrs, _} = _el | _els], Binval,
                       Extval, Phonetic) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_SOUND_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"EXTVAL">>, _attrs, _} = _el | _els], Binval,
                       Extval, Phonetic) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_ORG(__TopXMLNS, __Opts,
    ...
    {Name, Units} = decode_vcard_ORG_els(__TopXMLNS,
                                         __Opts,
                                         _els,
                                         undefined,
                                         []),
...
decode_vcard_ORG_els(__TopXMLNS, __Opts, [], Name,
                     Units) ->
    {Name, lists:reverse(Units)};
decode_vcard_ORG_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"ORGNAME">>, _attrs, _} = _el | _els], Name,
                     Units) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_ORG_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"ORGUNIT">>, _attrs, _} = _el | _els], Name,
                     Units) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
encode_vcard_PHOTO({vcard_photo, Type, Binval, Extval},
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    ...
                                    __TopXMLNS),
    _els =
        lists:reverse('encode_vcard_PHOTO_$extval'(Extval,
                                                   __NewTopXMLNS,
...
encode_vcard_LOGO({vcard_logo, Type, Binval, Extval},
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = lists:reverse('encode_vcard_LOGO_$extval'(Extval,
                                                     __NewTopXMLNS,
...
encode_vcard_GEO({vcard_geo, Lat, Lon}, __TopXMLNS) ->
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = lists:reverse('encode_vcard_GEO_$lon'(Lon,
                                                 __NewTopXMLNS,
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts, [], Home,
                       Work, Internet, Pref, X400, Userid) ->
    {Home, Work, Internet, Pref, X400, Userid};
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"HOME">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"WORK">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"INTERNET">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"PREF">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"X400">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_EMAIL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"USERID">>, _attrs, _} = _el | _els], Home,
                       Work, Internet, Pref, X400, Userid) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
encode_vcard_EMAIL({vcard_email,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    ...
                                    __TopXMLNS),
    _els =
        lists:reverse('encode_vcard_EMAIL_$userid'(Userid,
                                                   __NewTopXMLNS,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts, [], Home, Work,
                     Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem, Isdn,
                     Pcs, Pref, Number) ->
    {Home,
     Work,
     Voice,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"HOME">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"VOICE">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"FAX">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"PAGER">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"MSG">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"CELL">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"VIDEO">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"BBS">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"MODEM">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"ISDN">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"PCS">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_TEL_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"NUMBER">>, _attrs, _} = _el | _els], Home,
                     Work, Voice, Fax, Pager, Msg, Cell, Video, Bbs, Modem,
                     Isdn, Pcs, Pref, Number) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts, [], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    {Home,
     Work,
     Postal,
     Parcel,
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"POSTAL">>, _attrs, _} = _el | _els], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"PARCEL">>, _attrs, _} = _el | _els], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"DOM">>, _attrs, _} = _el | _els], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"INTL">>, _attrs, _} = _el | _els], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_LABEL_els(__TopXMLNS, __Opts,
                       [{xmlel, <<"LINE">>, _attrs, _} = _el | _els], Home,
                       Work, Postal, Parcel, Dom, Intl, Pref, Line) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_ADR_els(__TopXMLNS, __Opts, [], Home, Work,
                     Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd, Street,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"HOME">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"POBOX">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"EXTADD">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"STREET">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"LOCALITY">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"REGION">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"PCODE">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
decode_vcard_ADR_els(__TopXMLNS, __Opts,
                     [{xmlel, <<"CTRY">>, _attrs, _} = _el | _els], Home,
                     Work, Postal, Parcel, Dom, Intl, Pref, Pobox, Extadd,
                     Street, Locality, Region, Pcode, Ctry) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
...
encode_vcard_ADR({vcard_adr,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = lists:reverse('encode_vcard_ADR_$ctry'(Ctry,
                                                  __NewTopXMLNS,
...
decode_vcard_N_els(__TopXMLNS, __Opts, [], Family,
                   Given, Middle, Prefix, Suffix) ->
    {Family, Given, Middle, Prefix, Suffix};
decode_vcard_N_els(__TopXMLNS, __Opts,
                   [{xmlel, <<"FAMILY">>, _attrs, _} = _el | _els], Family,
                   Given, Middle, Prefix, Suffix) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_N_els(__TopXMLNS, __Opts,
                   [{xmlel, <<"GIVEN">>, _attrs, _} = _el | _els], Family,
                   Given, Middle, Prefix, Suffix) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_N_els(__TopXMLNS, __Opts,
                   [{xmlel, <<"MIDDLE">>, _attrs, _} = _el | _els], Family,
                   Given, Middle, Prefix, Suffix) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_N_els(__TopXMLNS, __Opts,
                   [{xmlel, <<"PREFIX">>, _attrs, _} = _el | _els], Family,
                   Given, Middle, Prefix, Suffix) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
decode_vcard_N_els(__TopXMLNS, __Opts,
                   [{xmlel, <<"SUFFIX">>, _attrs, _} = _el | _els], Family,
                   Given, Middle, Prefix, Suffix) ->
    case xmpp_codec:get_attr(<<"xmlns">>,
                             _attrs,
                             __TopXMLNS)
...
encode_vcard_N({vcard_name,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"vcard-temp">>,
                                    [],
                                    __TopXMLNS),
    _els = lists:reverse('encode_vcard_N_$suffix'(Suffix,
                                                  __NewTopXMLNS,
