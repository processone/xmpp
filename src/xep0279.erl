...
decode_sic(__TopXMLNS, __Opts,
    ...
    {Ip, Port} = decode_sic_els(__TopXMLNS,
                                __Opts,
                                _els,
                                undefined,
                                undefined),
...
encode_sic({sic, Ip, Port, Xmlns}, __TopXMLNS) ->
    __NewTopXMLNS = xmpp_codec:choose_top_xmlns(Xmlns,
                                                [<<"urn:xmpp:sic:0">>,
                                                 <<"urn:xmpp:sic:1">>],
                                                __TopXMLNS),
    _els = lists:reverse('encode_sic_$port'(Port,
                                            __NewTopXMLNS,
                                            'encode_sic_$ip'(Ip,
                                                             __NewTopXMLNS,
                                                             []))),
...
decode_sic_port(__TopXMLNS, __Opts,
    ...
    Cdata = decode_sic_port_els(__TopXMLNS,
                                __Opts,
                                _els,
                                <<>>),
    Cdata.
...
decode_sic_port_els(__TopXMLNS, __Opts,
    ...
    decode_sic_port_els(__TopXMLNS,
                        __Opts,
                        _els,
...
decode_sic_ip(__TopXMLNS, __Opts,
    ...
    Cdata = decode_sic_ip_els(__TopXMLNS,
                              __Opts,
                              _els,
                              <<>>),
    Cdata.
