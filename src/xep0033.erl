...
get_els({address, _type, _jid, _desc, _node, _delivered,
	 _sub_els}) ->
    _sub_els.

set_els({address, _type, _jid, _desc, _node, _delivered,
	 _},
	_sub_els) ->
    {address, _type, _jid, _desc, _node, _delivered,
     _sub_els}.
...
decode_address(__TopXMLNS, __Opts,
    ...
    __Els = decode_address_els(__TopXMLNS, __Opts, _els,
			       []),
...
decode_address_els(__TopXMLNS, __Opts,
    ...
    case proplists:get_bool(ignore_els, __Opts) of
      true ->
	  decode_address_els(__TopXMLNS, __Opts, _els,
			     [_el | __Els]);
      false ->
